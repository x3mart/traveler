...
class TourMixin():
    def check_required_fieds(self, instance, current_section=None, errors={}):
        ...
        if instance.prepay_amount and instance.prepay_in_prc and instance.prepay_amount < 15:
            ...
            errors['prepay_amount'] = [_("Предоплата без учета скидки не может быть меньше") + f" {math.ceil(instance.price*0.15)} {instance.currency.short_name if instance.currency else ''}"]
    ...
    def set_fk_fields(self, request, instance):
        ...
        if start_city and start_city.get('id'):
            ...
            setattr(instance, 'start_destination', destination)
        ...
        if finish_city and finish_city.get('id'):
            ...
            setattr(instance, 'finish_destination', destination)
