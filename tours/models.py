...
class Tour(models.Model):
    ...
    start_russian_region = models.ForeignKey("geoplaces.CountryRegion", verbose_name=_("Российский регион начала путешествия"), on_delete=models.CASCADE, related_name='tours_by_start_russian_region', null=True, blank=True)
    finish_russian_region = models.ForeignKey("geoplaces.CountryRegion", verbose_name=_("Российский регион завершения путешествия"), on_delete=models.CASCADE, related_name='tours_by_finish_russian_region', null=True, blank=True)
    ...
    postpay_days_before_start = models.PositiveIntegerField(_('Дни внесения полной суммы до старта'), default=3, blank=True, null=True,)
