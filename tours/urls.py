...
from .views import ActiveDestinationViewSet, ActiveRegionViewSet, ActiveTypeViewSet, MainMenu, StartPage, TourAccomodationTypeViewSet, TourPropertyTypeViewSet, TourTypeViewSet, TourViewSet
...
router.register(r'active_types', ActiveTypeViewSet, basename='active_type')
