...
class VerificationRequest(models.Model):
    ...
    residency = models.ForeignKey('geoplaces.Destination', verbose_name=_('Резидент'), on_delete=models.PROTECT, related_name="%(app_label)s_%(class)s_citizenship", null=True, blank=True,)
    ...
    tours_countries = models.ManyToManyField('geoplaces.Destination', verbose_name=_('В какие страны туры'), blank=True,)
