...
class ExpertAdmin(UserAdmin, TranslationAdmin):
    ...
    fieldsets = ((None, {'fields':('last_visit', 'first_name', 'last_name', 'email', 'password', 'phone', 'avatar', 'country', 'city', 'is_active', 'email_confirmed', 'phone_confirmed', 'docs_confirmed', 'status_confirmed', 'visited_countries', 'languages', 'about')}),)
