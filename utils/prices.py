...
def get_tour_discounted_price(obj):
    if obj.price and obj.discount and obj.discount_starts and  obj.discount_finish and obj.discount_starts < date.today().date() and  obj.discount_finish > date.today().date():
